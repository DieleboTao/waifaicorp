// server.cjs – WaifaiCorp with NO email requirements (OTP disabled)
...
// ============ DIRECT SIGNING (NO OTP, NO EMAIL) ============
...
app.listen(PORT, () => {
  ...
  console.log(`📋 No email verification – signup and signing work immediately.`);
});